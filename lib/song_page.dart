...
class _SongPageState extends State<SongPage> {
  ...
  Widget statusCard(PlaylistDetails? details, BuildContext context,
      YoutubePlayerController controller) {
      ...
      onTap: () async {
        ...
        if (details == null) {
          ...
          if (details.playlistTag == 'stotra') {
            ...
            if (result != null &&
                result.containsKey('currentSong') &&
                result.containsKey('playlist') &&
                result.containsKey('postitionInList') &&
                result.containsKey('suggestionStreak')) {
              SongDetails currentSong1 = result['currentSong'];
              PlaylistDetails? playlist = result['playlist'];
              int postitionInList = result['postitionInList'];
              String suggestionStreak = result['suggestionStreak'];
              print('Received Parameters: $currentSong, $postitionInList');
              Navigator.pushReplacement(
                context,
                MaterialPageRoute(builder: (context) {
                  return SongPage(
                    ...
                    suggester: suggester,
                    suggestionStreak: suggestionStreak,
                    postitionInList: postitionInList,
                    playlist: playlist,
                  );
                }),
              );
