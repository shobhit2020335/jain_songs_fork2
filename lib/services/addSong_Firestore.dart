...
void main() async {
  ...
  currentSong.extraSearchKeywords('DSJMAB',
      englishName: '',
      hindiName: '',
      originalSong: '',
      album: '',
...
class AddSong {
  Map<String, dynamic> currentSongMap = {
    ...
    'language': 'Hindi',
    'likes': 0,
    'lyrics': 'Song lyrics not available at the moment.\n',
    'englishLyrics': '',
    'originalSong': '',
    'popularity': 0,
    'production': '',
    'share': 0,
    'singer': 'Aane Se Uske Aaye Bahar | Mohammed Rafi',
    'songNameEnglish': 'Darshan Se Jeevan Me Aaye Bahar',
    'songNameHindi': 'दर्शन से जीवन में आये बहार',
    'tirthankar': '',
    'totalClicks': 0,
    'todayClicks': 0,
    'trendPoints': 0.0,
    'youTubeLink': 'https://youtu.be/MuO77d1QvsE',
  };
